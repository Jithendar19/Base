	...
	<div class="site-wrap">
		...
		<div>
			<div class="article" style="max-width: 600px">
				...
				<img style="max-width: 600px" src="${pageContext.request.contextPath}/resources/images/journalsm.jpg" alt="">
				<p>We intend to provide various services for researchers and professional with new RNA sequence 
				representation in which 2D structural information is embedded in the sequence with desirable 
				features. Our new representation is a linear sequence which unambiguously and (structurally) 
				uniquely identifies the corresponding 2D structure. Any structure in non-nested form 
				(a pseudo-knot) can be distinguished from other structures easily. 
				<br /><br />You can submit your data 
				to us at the link below. <a href="#">Submit Here</a></p>
			</div>
			<ul>
				<li>
					<h3>SUBMIT</h3>
		...
		<div id="footer">
			<div>
				<p><span>2015 &copy; RNA SSAC Project funded by the <a href="http://www.nsf.gov/">NSF</a>.</span>
