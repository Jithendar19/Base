...
//    check if the list stored in a file is empty
    public boolean checkEmpty() throws IOException, ClassNotFoundException {
        ...
        try{
            inputStream = new ObjectInputStream(new FileInputStream("/opt/NSF_Data_FilesNSF_Data_Files/RegExp_Info_List.txt"));
        }catch(IOException e){
    ...
    public void saveToFile(){
        ...
        try{
            outputStream = new ObjectOutputStream(new FileOutputStream("/opt/NSF_Data_FilesNSF_Data_Files/RegExp_Info_List.txt"));
        }catch(IOException e){
